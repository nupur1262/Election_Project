...
contract("Election" , function(accounts){
    ...
    //To check if the total number of candidates are 3
    it("Initialized with three candidates" , function(){
    ...
    //To check if the candidates are initialized with correct values
    //name and total vote count
